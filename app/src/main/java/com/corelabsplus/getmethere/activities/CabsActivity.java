...
import com.corelabsplus.getmethere.utils.DrawerUtil;
...
public class CabsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener {
    ...
    BitmapDescriptor personMarker, cabMarker;
...
//        getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        cabMarker = BitmapDescriptorFactory.fromResource(R.drawable.cab_marker);
...
//                GETTING BUSSES
                for (DataSnapshot busSnapshot : dataSnapshot.child("cabs").getChildren()){
                    ...
                    Bus theBus = new Bus(plate, agency, origin, "Standing", seats, mLatLng);
                    buses.add(theBus);
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(CabsActivity.this, "Unknown error", Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//                            Log.d(TAG, "onComplete: current location is null");
                            Toast.makeText(CabsActivity.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
...
//        Log.d(TAG, "initMap: initializing map");
        ...
        mapFragment.getMapAsync(CabsActivity.this);
    }
