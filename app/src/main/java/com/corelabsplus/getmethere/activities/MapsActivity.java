...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener {
    ...
    private FloatingActionButton setLocations;
//    private static final LatLngBounds LAT_LNG_BOUNDS = new LatLngBounds(
//            new MLatLng(-40, -168), new MLatLng(71, 136));
    ...
    private RelativeLayout setPickUpButton, locationInputHolders;
...
//        getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        setLocations = (FloatingActionButton) findViewById(R.id.applyLocations);
        setPickUpButton = (RelativeLayout) findViewById(R.id.setPickUpLocation);
        locationInputHolders = (RelativeLayout) findViewById(R.id.setLocations);

        setLocations.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent chooseMode = new Intent(MapsActivity.this, SelectModeActivity.class);
